...
sap.ui.define([
		...
		return BaseController.extend("com.sap.build.standard.otcOptimization.controller.Inbox", {
				...
				if (requiredFieldInfo) {
					requiredFieldInfo.forEach(function (requiredinfo) {
						...
						if (input) {
							...
							//initially set ValueState to None
							if (input.getValue() === "") {
								input.setValueState("Error");
								//input is blank set ValueState to error
								status = false;
							} else if (input.getDateValue && !input._bValid) {
								//since 1.64 ui5 will be providing a function 'isValidValue' that can be used here.
								input.setValueState("Error");
								//Invalid Date set ValueState to error
								status = false;
							}
						}
					});
			...
			/**
			 *@memberOf com.sap.build.standard.otcOptimization.controller.Inbox
			 */
